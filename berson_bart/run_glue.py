...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in train_iterator:
        ...
        # 测试
        results = evaluate(args, model, tokenizer, prefix='test')
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        ...
        output_only_eval_file_1 = os.path.join(args.output_dir, prefix, "all_eval_results.txt")
...
def main():
    ...
    tokenizer, model = init_model('S', args.model_name_or_path, device=args.device, do_lower_case=args.do_lower_case)
