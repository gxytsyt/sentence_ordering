...
class PreTrainedTokenizer(PreTrainedTokenizerBase):
    ...
    def encode_plus_my(self,
        ...
        return self.prepare_for_model_my(first_ids,
    ...
    def prepare_for_model_my(self, ids, max_length=None, add_special_tokens=False, stride=0,
        ...
        if passage_length != len(sents):
            print ('original_src', original_src)
            print (b)
        ...
        sfdoc = [sents[ri] for ri in shuffled_index]  # [1 2 4 3 0]
